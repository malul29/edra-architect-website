      ...
      <div className={`mobile-menu ${mobileOpen ? 'active' : ''}`}>
        ...
        <div className="mobile-menu-footer">
          <div className="mobile-social">
            ...
            {/* YouTube */}
            <a href="https://youtube.com/@edra-architects" target="_blank" rel="noopener noreferrer" className="mobile-social-link" aria-label="YouTube">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com/company/edra-architects" target="_blank" rel="noopener noreferrer" className="mobile-social-link" aria-label="LinkedIn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
