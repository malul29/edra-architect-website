                    ...
                    <div className="contact-info-wrapper">
                        ...
                        <div className="git-social">
                            ...
                            <div className="git-social-icons">
                                ...
                                <a href="https://linkedin.com/company/edra-architects" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="git-social-btn">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                                ...
                                <a href="https://youtube.com/@edra-architects" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="git-social-btn">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
